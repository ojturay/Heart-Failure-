...
coords(testroccurve, x = 'best', best.method = 'closest.topleft')
#AUC for the testing dataset in 70.71% with the optimal point indicating the 
#highest sensitivity and specificity possible for the model based on the test 
#date at 77.78% and 74.65% respectively
...
coords(trainroccurve, x = 'best', best.method = 'closest.topleft')
#AUC for the training dataset in 76.21%  with the optimal point indicating the 
#highest sensitivity and specificity possible for the model based on the test 
#date at 70% and 71.14% respectively
